	...
	<div class="container">
		...
		<c:choose>
			...
			<c:if test="${!empty success }">
				...
				<a class="btn btn-primary float-right" href="/Ecommerce_Manager_beta/category/create"
					...
					<tbody>
						<c:forEach items="${categories }" var="category">
							<tr>
								...
								<td>${category.name }</td>
								<td><a
									href="/Ecommerce_Manager_beta/category/details?id=${category.id }">Details</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
