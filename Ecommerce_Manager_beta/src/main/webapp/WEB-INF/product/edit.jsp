	...
	<div class="container ">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-3">
				...
				<form action="/Ecommerce_Manager_beta/product/edit?id=${ product.id }" method="post">
					<h3 class="col-md-offset-3">Edit Product Informations </h3>
					...
					<div class="form-group ">
						<label for="mark">Mark : </label> <input type="text"
							class="form-control" id="mark" name="mark" value="${product.mark }"
					...
					<div class="form-group">
						<label for="module">Category : </label> <select
